...
import com.tolstoy.zurichat.ui.adapters.SettingsAdapter;
...
public class SlideThreeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(v -> {
            startActivity(new Intent(getActivity(), SettingsAdapter.class));
            editor.putBoolean(show_intro, false);
            editor.apply();
        });
        skip.setOnClickListener(v -> startActivity(new Intent(getActivity(), SettingsAdapter.class)));
    }
}